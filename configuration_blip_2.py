...
class Blip2VisionConfig(PretrainedConfig):
    ...
    def __init__(
        self,
        hidden_size=1024,  # 1280 * 5,  # 1024,
        intermediate_size=3072,  # 6144,
        projection_dim=512,
        num_hidden_layers=8,  # 39,
...
class Blip2QFormerConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        encoder_hidden_size=1024,  # 1280 * 5,  # 1024,
        **kwargs,
        ):
...
class Blip2Config(PretrainedConfig):
    ...
    def __init__(self, vision_config=None, qformer_config=None, text_config=None, num_query_tokens=32, **kwargs):
        ...
        text_model_type = "opt"  # text_config["model_type"] if "model_type" in text_config else "opt"
        self.text_config = text_config  # CONFIG_MAPPING[text_model_type](**text_config)
        ...
        self.use_decoder_only_language_model = True  # self.text_config.model_type in MODEL_FOR_CAUSAL_LM_MAPPING_NAMES
